    ...
    <header class="navbar navbar-fixed-top bg-white">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand"><span class="text-danger">Cust</span> Call</a>
            </div>
    ...
    <div id="landing-content">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-right">
                            <h2 class="m-top-lg m-right-md text-white fadeInDownLarge animation-delay3">The Most Flexible & Lightweight</h2>
                ...
                <div class="item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <h2 class="m-top-lg text-white fadeInDownLarge animation-delay3">Fully Responsive Design</h2>
                ...
                <div class="item">
                    ...
                    <div class="row text-center">
                        ...
                        <a href="#" class="btn btn-default btn-lg fadeInLeftLarge animation-delay8">Get It Now</a>
        ...
        <div class="bg-white text-center content-padding">
            <div class="container">
                ...
                <img src="img/screenshot.jpg" alt="" class="fadeInRightLarge no-animation animated-element m-top-md">
            ...
            <div class="container">
                <div class="panel">
                    <div class="panel-body content-padding">
                        ...
                        <a href="#" class="btn btn-lg btn-danger pull-right m-top-xs fadeInLeftLarge no-animation animated-element">PURCHASE NOW</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3 padding-md">
                    ...
                    <div class="seperator"></div>
                    <a class="btn btn-default btn-info"><i class="fa fa-envelope"></i> Contact support</a>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div>
    </footer>
