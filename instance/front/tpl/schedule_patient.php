        ...
        <div class="panel-body">
            <form method="post" action="<?php l('schedule_patient') ?>" class="form-horizontal" role="form">
                <div class="form-group ">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="text"  name="name" id="name" value="" placeholder="Add Name" required>
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="text"  name="age" id="age" value="" placeholder="Add Age" required>
                    </div>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="text"  name="address" id="address" value="" placeholder="Add Address" >
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="text"  name="phno" id="phno" value="" placeholder="Add Phone Number" required>
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="col-lg-2 control-label">Email</label>
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="email"  name="email" id="email" value="" placeholder="Add Email" required>
                    </div>
                </div>
                <div class="form-group ">
                    <label  class="col-lg-2 control-label">Message</label>
                    <div class="col-lg-5">
                        <input class="form-control input-sm" type="text"  name="message" id="message" value="" placeholder="Add Message" required>
                    </div>
                </div>
