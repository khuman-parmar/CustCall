...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php l('home') ?>" style="color:#00ffff">Twilio Call</a>
    </div>

    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            <li><a href="<?php l() ?>">Dashboard</a></li>
            <li><a href="<?php l('') ?>">Componant</a></li>
			 <li><a href="<?php l('') ?>">Page</a></li> 
			 <li><a href="<?php l('') ?>">TimeLine</a></li>
          <!--  <li class="dropdown">
