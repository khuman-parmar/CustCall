...
try {
    $call = $client->account->calls->create(
            $phonenumber, $call_data['phno'], 'http://166.78.186.70/alert_cloud/dev/instance/front/tpl/phonemenu/phonemenu.php'
			    //  $phonenumber, $call_data['phno'], 'http://166.78.186.70/alert_cloud/dev/instance/front/tpl/ivrs-extensions/handle-extension.php'
    );
    $response['msg'] = '1';
